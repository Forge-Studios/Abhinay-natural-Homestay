...
export default function ResortHero() {
  return (
    <div className="relative w-full max-w-[95vw] 2xl:max-w-400 mx-auto rounded-3xl overflow-hidden shadow-2xl">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-6">
          <div className="max-w-4xl">
            ...
            <p className="text-white/80 text-lg mb-10 max-w-2xl mx-auto leading-relaxed">
              Whether you wish to relax by the pool, embark on a Hills adventure, or explore the rich cultural heritage of North Bengal, our resort offers a range of activities to suit your every mood.
            </p>

            {/* Book Now Button with Glass Effect */}
            <button className="px-10 py-4 rounded-full font-bold tracking-wider text-sm uppercase flex items-center gap-2 mx-auto group transition-all duration-300
