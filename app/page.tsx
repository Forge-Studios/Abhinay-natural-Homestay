  ...
  return (
    <main className="bg-app-bg min-h-screen font-body selection:bg-brand-primary/10">
      ...
      <section className="py-32 px-6 w-full">
        <div className="w-full max-w-[95vw] 2xl:max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
      ...
      {/* 4. ESCAPE SECTION */}
      <section className="w-full bg-#F6EDD9 px-6 py-20">
        <ResortHero />
      </section>
